...
void printf(char *str) { print(str, strlen(str)); }

void putchar(char c) { print(&c, 1); }
...
void *malloc(int size) { return memoryAllocation(size); }

void free(void *ptr) { memoryFree(ptr); }
...
int getPid() { return getProcessPid(); }
